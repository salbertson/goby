...
func TestAssignmentEvaluation(t *testing.T) {
	...
	for i, tt := range tests {
		...
		verifyIntegerObject(t, i, evaluated, tt.expectedValue)
		v.checkCFP(t, 0, 0)
		v.checkSP(t, i, 1)
	}
}
...
func TestAssignmentByOperationEvaluation(t *testing.T) {
	...
	for i, tt := range tests {
		v := initTestVM()
		evaluated := v.testEval(t, tt.input, getFilename())
		VerifyExpected(t, i, evaluated, tt.expectedValue)
		v.checkCFP(t, 0, 0)
		v.checkSP(t, i, 1)
	}
}
...
func TestClassInheritance(t *testing.T) {
	...
	verifyStringObject(t, 0, evaluated, "Bar")
	v.checkCFP(t, 0, 0)
	v.checkSP(t, 0, 1)
}
...
func TestComment(t *testing.T) {
	...
	v := initTestVM()
	evaluated := v.testEval(t, input, getFilename())
	verifyIntegerObject(t, 0, evaluated, 123)
	v.checkCFP(t, 0, 0)
	v.checkSP(t, 0, 1)
}
...
func TestComplexEvaluation(t *testing.T) {
	...
	v := initTestVM()
	evaluated := v.testEval(t, input, getFilename())
	verifyIntegerObject(t, 0, evaluated, 310)
	v.checkCFP(t, 0, 0)
	v.checkSP(t, 0, 1)
}
...
func TestEnvironmentVariable(t *testing.T) {
	...
	v := initTestVM()
	evaluated := v.testEval(t, input, getFilename())
	VerifyExpected(t, 0, evaluated, "This is foo. This is bar.")
	v.checkCFP(t, 0, 0)
	v.checkSP(t, 0, 1)
